...
module tb_lfm_radar_core;
    ...
    always @(posedge clk) begin
        if (result_valid && result_ready) begin
            ...
            endcase
            if (result_last && packet_word != 5)
                $fatal(1, "result TLAST asserted at word %0d, expected word 5",
                       packet_word);
